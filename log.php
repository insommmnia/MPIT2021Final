        ...
        <section class="signup">
            ...
            <div class="container">
                ...
                <div class="signup-content">
                    ...
                    <form method="POST" id="signup-form" action="reg.php" enctype="multipart/form-data" class="signup-form">
                        <h2 class="form-title">Создать аккаунт</h2>
                        <div class="form-group">
                            <input type="text" class="form-input" name="name" id="name" placeholder="Ваше Имя"/>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="surname" id="email" placeholder="Ваша Фамилия"/>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="age" id="email" placeholder="Ваш Возраст"/>
                        </div>
                        <div class="form-group">
...
<option value="Zimbabwe">Zimbabwe</option>
                        ...
                        <div class="form-group">
                            ...
                            <label for="agree-term" class="label-agree-term"><span><span></span></span>Я согласен с <a href="#" class="term-service">Политикой обработки данных</a></label>
                        </div>
                        <div class="form-group">
                            <input type="submit"  name="submit" id="submit" class="form-submit" value="Зарегистрироваться"/>
                        </div>
                    </form>
                    <p class="loginhere">
                        Уже есть аккаунт? <a href="log2.php" class="loginhere-link">Войти здесь</a>
                    </p>
